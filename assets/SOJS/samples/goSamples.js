// Highlight.js:
if (window.require) {
  require([base_url+"assets/SOJS/js/highlight.js"], function() {
    //This function is called after some/script.js has loaded.
  });
} else {
  document.write('<script src="'+base_url+"assets/SOJS/js/highlight.js"'"></script>');
}

var link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = base_url+"assets/SOJS/css/highlight.css";
